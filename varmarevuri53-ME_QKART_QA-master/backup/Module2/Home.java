...
public class Home {
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            List<WebElement> items = driver.findElements(By.xpath("//div[@class='MuiBox-root css-1gjj37g']/div[1]"));
            ...
            for(int i=0 ; i<expectedCartContents.size(); i++){
               ...
               System.out.println("Expected Cart products : "+ cartItemIndex + " = " + "Actual Cart Products :" + actualCartItemText);
