...
public class QkartSanity {
    ...
    public static void takeScreenshot(WebDriver driver, String screenshotType, String description) {
        ...
        try {
            File theDir =
                    new File("/home/crio-user/workspace/varmarevuri53-ME_QKART_QA/app/screenshots");
            if (!theDir.exists()) {
                theDir.mkdirs();
            }
    ...
    public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "StartTestCase", "TestCase01.png");
        Boolean status;
        ...
        if (!status) {
            ...
            logStatus("End TestCase", "Test Case 1: Verify user Registration : ",
                    status ? "PASS" : "FAIL");
            takeScreenshot(driver, "RegistationFiledTestCase", "TestCase01.png");
        ...
        logStatus("End TestCase", "Test Case 1: Verify user Registration : ",
                status ? "PASS" : "FAIL");
        takeScreenshot(driver, "EndTestCase", "TestCase01.png");
    ...
    public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "StartTestCase", "TestCase02.png");
        Boolean status;
        ...
        logStatus("End TestCase", "Test Case 2: Verify user Registration : ",
                status ? "FAIL" : "PASS");
        takeScreenshot(driver, "EndTestCase", "TestCase02.png");
        return !status;
    }
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "StartTestCase", "TestCase03.png");
        ...
        if (!status) {
            logStatus("TestCase 3", "Test Case Failure. Unable to search for given product",
                    "FAIL");
            takeScreenshot(driver, "UnableToSearchProductTestCaseFailed", "TestCase03.png");
            return false;
        }
        ...
        // wait.until(ExpectedConditions.visibilityOfAllElements(driver.findElements(By.xpath("//div[@class='MuiCardContent-root
        // css-1qw96cp']"))));
        ...
        takeScreenshot(driver, "EndTestCase", "TestCase03.png");
    ...
    public static Boolean TestCase04(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "StartTestCase", "TestCase04.png");
        ...
        takeScreenshot(driver, "EndTestCase", "TestCase04.png");
        return status;
    }
    ...
    public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "StartTestCase", "TestCase05.png");
        Boolean status;
        ...
        logStatus("End TestCase", "Test Case 5: Happy Flow Test Completed : ",
                status ? "PASS" : "FAIL");
        takeScreenshot(driver, "EndTestCase", "TestCase05.png");
        return status;
    }
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "StartTestCase", "TestCase06.png");
        Boolean status;
        ...
        logStatus("End TestCase", "Test Case 6: Verify that cart can be edited: ",
                status ? "PASS" : "FAIL");
        takeScreenshot(driver, "EndTestCase", "TestCase06.png");
        return status;
    }
    ...
    public static Boolean TestCase07(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "StartTestCase", "TestCase07.png");
        Boolean status = false;
        ...
        // TODO: Register a new user
        registration.navigateToRegisterPage();
        status = registration.registerUser("Surendra", "test123", true);
        if (!status) {
        ...
        login.navigateToLoginPage();
        status = login.PerformLogin(lastGeneratedUserName, "test123");
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
        ...
        homePage.PerformLogout();
        takeScreenshot(driver, "EndTestCase", "TestCase07.png");
        return status;
    }

    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        takeScreenshot(driver, "StartTestCase", "TestCase08.png");
        Boolean status;
        logStatus("Start TestCase",
        ...
        logStatus("End TestCase",
                "Test Case 8: Verify that insufficient balance error is thrown when the wallet balance is not enough: ",
                status ? "PASS" : "FAIL");
        takeScreenshot(driver, "EndTestCase", "TestCase08.png");
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Start TestCase",
                "Test Case 9: Verify the cart product details available if customer open new tab",
                "DONE");
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        status = registration.registerUser("testUser", "abc@123", true);
        ...
        status = homePage.searchForProduct("YONEX");
        homePage.addProductToCart("YONEX Smash Badminton Racquet");
        String prntWind = driver.getWindowHandle();
        ...
        for (String childWind : allWinds) {
            driver.switchTo().window(childWind);
            WebElement homepageUserName =
                    driver.findElement(By.xpath("//*[@class='username-text']"));
            if (homepageUserName.isDisplayed()) {
                status = homePage.verifyCartContents(expectedResult);
                takeScreenshot(driver, "AfterSwitchingWindow", "TestCase09");

            }

            logStatus("End TestCase", "Test Case 9: Verify that cart contents are persisted ",
                    status ? "PASS" : "FAIL");

        }
        driver.close();
        driver.switchTo().window(prntWind);




        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
         takeScreenshot(driver, "EndTesCase", "TestCase09");
        //Thread.sleep(3000);
        return status;
    }
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        ...
        // Click on Privacy Policy page link in the footer
        ...
        String expectedUrl = "https://crio-qkart-frontend-qa.vercel.app/";
        status = currentUrl.equals(expectedUrl);
        logStatus("Test Case 10", "URL verification : ", status ? "PASS" : "FAIL");
        ...
        for (String childWindow : allWindows) {
            if (!parentWindow.equals(childWindow)) {
                ...
                status = privacyContent.isDisplayed();
                logStatus("Test Case 10", "Privacy Policy content displayed : ",
                        status ? "PASS" : "FAIL");
                driver.close();
            }
        ...
        WebElement termsOfServiceLink =
                driver.findElement(By.xpath("//a[text()='Terms of Service']"));
        termsOfServiceLink.click();

        // Verify that the URL of the current tab does not change
        currentUrl = driver.getCurrentUrl();
        expectedUrl = "https://crio-qkart-frontend-qa.vercel.app/";
        status = currentUrl.equals(expectedUrl);
        logStatus("Test Case 10", "URL verification : ", status ? "PASS" : "FAIL");
        ...
        for (String childWindow : allWindows) {
            if (!parentWindow.equals(childWindow)) {
                ...
                status = aboutUsContent.isDisplayed();
                logStatus("Test Case 10", "About Us content displayed : ",
                        status ? "PASS" : "FAIL");
            }
        }
    ...
    // else {
    // status = false;
    // logStatus("Test Cse 10", "Unable to find the web element ", status ? "PASS" : "FAIL");
    // }
    // return status;
    // }
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        ...
        try {
            ...
            logStatus("Test Case 11", "Successully Entered Username 😊", "PASS");
            driver.findElement(By.xpath("//input[@placeholder='Email']"))
                    .sendKeys("criouser@gmail.com");
            logStatus("Test Case 11 ", "Successfully Entered Email 😊", "PASS");
            driver.findElement(By.xpath("//input[@placeholder='Message']"))
                    .sendKeys("Testing the contact us page");
            logStatus("Test Case 11", "Succcessfully Entered Message 😊", "PASS");
            WebElement clkBtn = driver.findElement(By.xpath("//button[text()=' Contact Now']"));
            // Thread.sleep(3000);
            clkBtn.click();
            // Thread.sleep(3000);
            ...
            boolean isDialogClosed =
                    driver.findElements(By.xpath("//button[text()=' Contact Now']")).size() == 0;
            assert isDialogClosed : "Contact now dialog did not close";
            logStatus("Test Case 11", "Contact now dialog closed 😊", "PASS");
    ...
    public static Boolean TestCase12(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Registration Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase",
                    "Test Case 12: Verify the cart product details available if customer open new tab: ",
                    status ? "PASS" : "FAIL");
            return false;
        }
        ...
        System.out.println("Test Case 12 : Total available frames in the page : " + totalFrames);
        if (totalFrames == 3) {
            System.out.println("Test Case 12 : Three Frames are available in the Web Page :  PASS");
        } else {
            System.out.println(
                    "Test Case 12 : Not Three Frames are available in the Web Page :  FAIL");
        }

        for (int i = 0; i < frames.size() - 1; i++) {
            driver.switchTo().frame(i);
            WebElement cartBtn = driver.findElement(By.xpath("//button[text()='View Cart']"));
            cartBtn.click();
            status = driver.getCurrentUrl().equals("https://crio-qkart-frontend-qa.vercel.app/");
            logStatus("Test Case12 ", "Inside the frame view cart button is clickable",
                    status ? "PASS" : "FAIL");
            driver.navigate().back();
            status = driver.getCurrentUrl()
                    .equals("https://crio-qkart-frontend-qa.vercel.app/thanks");
            logStatus("Test Case 12", "Successfully navigated back to /thanks page ",
                    status ? "PASS" : "FAIL");
            driver.switchTo().parentFrame();
            driver.switchTo().frame(i);


            WebElement buytBtn = driver.findElement(By.xpath("//button[text()='Buy Now']"));
            buytBtn.click();
            status = driver.getCurrentUrl()
                    .equals("https://crio-qkart-frontend-qa.vercel.app/checkout");
            logStatus("Test case 12", "Inside the frame Buy button is clickable",
                    status ? "PASS" : "FAIL");
            driver.navigate().back();
            status = driver.getCurrentUrl()
                    .equals("https://crio-qkart-frontend-qa.vercel.app/thanks");
